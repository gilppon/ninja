...
## 1. SNS 최전선 카피 (X/Threads/Facebook)
...
- **설명**: SNS 링크 공유 시 자동으로 나타나는 화려한 로비 화면입니다.

## 3. 추천 배포 전장 (Viral Channels)
| 전장 (채널) | 특징 | 추천 카피 |
| :--- | :--- | :--- |
| **X (Twitter)** | 실시간 확산성 최고 | 글로벌 카피 (KR/EN/JP) 혼합 |
| **Discord** | 인디 게임 매니아 집결 | "Insane game feel" 강조형 |
| **Reddit (r/webgames)** | 영미권 유저 직접 타격 | ENGLISH 카피 |
| **Community (디시/루리웹)** | 국내 핵심 게이머 층 | KOREAN 카피 |

---

> [!TIP]
> **부장의 추천**: 이미지와 함께 올리실 때, `public/og-preview.png`를 직접 첨부해서 올리시면 클릭률(CTR)이 더욱 상승합니다! 🚀
